...
<div id="container" align="center">
  <div id="new" class="one-half" align="center">
    <div class="heading_bg">
        ...
        <?php 
			//echo "car=".$car; 
			$q="select * from car where car_id='$car'";
...
//				echo $r[12];
		?>
         Select Company : &nbsp;&nbsp;
         <?php
         $query="select * from car_company where com_id='$r[11]'";
   ...
   <tr>
	...
	if(isset($_POST['update']))
	{
		...
		$q="update car set car_photo='$carimg',car_model='$model',cc='$cc',fuel='$fuel',seating_capacity='$seating',air_conditioner='$ac',alloy_wheel='$wheel',tubeless_tyres='$tyre',avg_km='$avkm',amount='$amount',com_id='$com_id' where car_id='$car'";
		...
		if($result==true)
		{
			...
			header("Location:caredit.php?id=$car");
		}
		else
					echo "Try Again....";
...
?>
  ...
  <tr>
    ...
    <td><input type="text" name="txtmodel" value="<?php echo $r[2]; ?>" style="border:ridge"></td>
  </tr>
    <tr>
      <td id="m">Displacement(cc):</td>
      <td><input type="text" name="txtcc" style="border:ridge" value="<?php echo $r[3]; ?>"></td>
    </tr>
  <tr>
    <td id="m">Fuel:</td>
    <td>
...
<?php */?>		
  ...
  <tr>
    ...
    <td><input type="text" name="txtseating" style="border:ridge" value="<?php echo $r[5]; ?>"></td>
  </tr>
   <tr>
    ...
    <?php 
	$a=$r[6];
	if($a=="Automatic climate control")
	{?>
   ...
   <tr>
    ...
    <td><input type="text" name="txtavg" style="border:ridge" value="<?php echo $r[9]; ?>"></td>
  </tr>
   <tr>
    <td id="m">Amount:</td>
    <td><input type="text" name="txtamount" style="border:ridge"value="<?php echo $r[10]; ?>"></td>
  </tr>
  <?php  } ?>
  <tr>
