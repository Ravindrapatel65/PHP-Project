  ...
  <div id="new" class="one-half" align="center">
    <div class="heading_bg">
		<h2>Upload new Car</h2>
 		...
 		<form action="" class="TTWForm" method="post" enctype="multipart/form-data" name="car_upload">  
   ...
   <tr>
	...
	if(isset($_POST['addcar']))
	{
		...
		$q="insert into car(car_photo,car_model,cc,fuel,seating_capacity,air_conditioner,alloy_wheel,tubeless_tyres,avg_km,amount,com_id)values('$carimg','$model',$cc,'$fuel',$seating,'$ac','$wheel','$tyre',$avkm,$amount,$com_id)";
		echo $q;
		
		$result=mysql_query($q) or die("query problem");
		//echo $com_id.$carimg;
		
		if($result==true)
		{
			echo "<script language='javascript'>alert('Inserted Successfully..');</script>";
			header("Location:uploadnewcar.php");
		}
		else
					echo "Try Again....";
...
?>
  ...
  <tr>
    <td  id="m"></td><td><center><input type="submit" name="addcar" 
    value="Upload" style="border-radius:5px" id="button" onClick="return upload_car();"></center></td>
  </tr>
